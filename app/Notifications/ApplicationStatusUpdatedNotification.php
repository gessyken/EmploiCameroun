...
class ApplicationStatusUpdatedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Update on your application for ' . $this->application->jobListing->title)
            ->line('The status of your application has been updated to: ' . $this->application->status)
